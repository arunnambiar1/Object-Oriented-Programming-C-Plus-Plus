...
/**
 * @brief Construct a new Charmander object (default)
 */
...
/**
 * @brief Construct a new Charmander object (overloaded)
 * @param name
 * @param hp
 * @param att
 * @param def
 ...
 * @param s  (skills)
 */
Charmander::Charmander(string name, int hp, int att, int def,
...
/**
 * @brief calls printStats from the parent class then appends Charmander skills
 */
